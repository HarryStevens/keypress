...
const startAngle = -90,
      ...
      treeMargin = {left: 2, right: 2, top: 2, bottom: 2};
const pieWidth = 800,
      pieHeight = 500,
...
const stackRects = g.selectAll(".stack-rect")
    .data(stack)
  .enter().append("rect")
    .attr("class", d => "stack-rect " + jz.str.toSlugCase(d.continent))
    .attr("x", d => d.x)
    .attr("y", d => d.y)
